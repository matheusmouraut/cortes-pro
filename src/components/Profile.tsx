      ...
      <div className="bg-white/70 backdrop-blur-xl border border-neutral-200/80 rounded-2xl p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col gap-8">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-1">
            <h2 className="text-[20px] font-semibold text-neutral-900">Usuário</h2>
            <p className="text-[14px] text-neutral-500">{user?.email || 'email@exemplo.com'}</p>
        ...
        <div className="flex justify-end">
          <button 
            ...
            className="px-5 py-2.5 bg-white border border-neutral-200 hover:bg-neutral-50 text-red-600 rounded-lg text-[14px] font-medium transition-colors cursor-pointer shadow-sm"
          >
            Sair da conta
          </button>
        </div>
